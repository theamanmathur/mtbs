...
<body style="background-image:url(11.jpg)">
    ...
    <p style="background-color:rgba(170,0,0,0.2);text-align:center;font-size:40px;color:silver;width:1500px;font-family:pristina;margin-top:5px;margin-bottom:10px;">your tickets</p>
    ...
    <div class="tk_details"><span class="movname">Movie : '.$out.'</span><br><br>Theatre : '.ucfirst($row["hall"]).'<br><br>Date : '.$row["dob"].'<br><br>Show Time : '.$row["showTime"].'<br><br>seats : '.$row["numSeats"].'<br><br>Paid : ₹'.$row["amount"].'</div>
    </div>';
